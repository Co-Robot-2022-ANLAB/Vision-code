...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle nh;
    tool_center_pub = nh.advertise<std_msgs::Int32MultiArray>("camera/tool_center", 10);
    tool_angle_pub = nh.advertise<std_msgs::Float64>("camera/tool_angle", 10);
...
//		if (0)
        ...
        //################ROS Publish###################
        std_msgs::Int32MultiArray tool_center;
        std_msgs::Float64 tool_angle;

        tool_center.data.clear();
        tool_center.data.push_back(a.center.x);
        tool_center.data.push_back(a.center.y);
